namespace GestionnaireMotDePasse
{
	partial class AddForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "To add a password you have to fill the folowing fields";
			// 
			// label2
			// 
			...
			this.label2.Text = "Website\'s name:";
			// 
			// label3
			// 
			...
			// website
			// 
			this.website.Location = new System.Drawing.Point(146, 71);
			this.website.Name = "website";
			this.website.Size = new System.Drawing.Size(100, 20);
			this.website.TabIndex = 5;
			// 
			// link
			// 
			this.link.Location = new System.Drawing.Point(146, 100);
			this.link.Name = "link";
			...
			// user
			// 
			this.user.Location = new System.Drawing.Point(146, 133);
			this.user.Name = "user";
			...
			// password
			// 
			this.password.Location = new System.Drawing.Point(146, 162);
